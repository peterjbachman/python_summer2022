...
# added encoding arg for some extra characters in some cards
with open('lab04_solution.csv', 'w', encoding="utf-8") as f:
    ...
    for i in all_faculty:
        ...
        try:
            prof_page = urllib.request.urlopen(
                'https://polisci.wustl.edu%s' % extension)
