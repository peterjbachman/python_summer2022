...
teststring = ["hello there", "together", "the.", "the  ", "hi there hi" "The",
              "The school", "hi the cat", "hi the", "there", "There is"]
for i in teststring:
    # print(i)
    print(the_patt.findall(i))
    print("")
nothe = [l for l in teststring if not the_patt.search(l)]
print(nothe)
...
# Day: DD
# Year: YY
date = "Please enter a date in the format MM.DD.YY: 08.18.21"
...
print("Month: %r \nDay: %r \nYear: %r" %
      (x.groups(0)[0], x.groups(0)[1], x.groups(0)[2]))
